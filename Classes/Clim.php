...
class Clim
{
     ...
     * @var \Clim\Helper\Color
     */
    private $colors;

    /**
     * Shortcut to an instance of Style
     * @var \Clim\Helper\Style
     */
    private $style;
    ...
    protected function __construct()
    {
        ...
        $this->stdOut = defined('STDOUT') && is_resource(STDOUT)
            ? STDOUT
            : fopen('php://stdout', 'ab');
        $this->stdErr = defined('STDERR') && is_resource(STDERR)
            ? STDERR
            : fopen('php://stderr', 'ab');
